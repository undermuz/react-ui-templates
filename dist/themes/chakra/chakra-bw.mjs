...
var { definePartsStyle, defineMultiStyleConfig } = createMultiStyleConfigHelpers(tabsAnatomy.keys);
...
var ChakraBwThemeFonts = () => /* @__PURE__ */ jsx(
  Global,
  {
    styles: `
